 ...
 * <PRE>
 * ******************************PROGRAM DESCRIPTION*******************************************************
 * Program Name  : DruidConfiguration.java
 * Description	:
 ...
 * </PRE>
 */
package com.excel.bookstore.conf;
...
@MapperScan(basePackages = {"com.excel.bookstore.dao.mapper"})
public class DruidConfiguration {
    ...
    public ServletRegistrationBean druidStatViewServlet() {
        ...
        servletRegistrationBean.addInitParameter("loginPassword", "excel");
        //是否能够重置数据.
    ...
    public FilterRegistrationBean druidStatFilter() {
        ...
        //添加不需要忽略的格式信息.
        filterRegistrationBean.addInitParameter("exclusions", "*.js,*.gif,*.jpg,*.png,*.css,*.ico,*.html,/druid/*");
